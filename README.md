...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 315,524 | 🐛 23 | 🌐 Python | 📅 2026-08-22.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,458 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-22 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,550 | 🐛 2,928 | 🌐 C++ | 📅 2026-08-22 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,913 | 🐛 122 | 🌐 Rust | 📅 2026-08-22 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,692 | 🐛 257 | 🌐 C++ | 📅 2026-08-22, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 25,892 | 🐛 20,776 | 🌐 Nix | 📅 2026-08-22
...
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,559 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-21
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,748 | 🐛 19 | 🌐 Rust | 📅 2026-08-21

...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,339 | 🐛 21 | 🌐 Python | 📅 2026-09-15.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,485 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-17 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,736 | 🐛 2,958 | 🌐 C++ | 📅 2026-09-17 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [meta](https://github.com/mateodelnorte/meta) ⭐ 2,226 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-17 is a tool for managing multi-project systems and libraries. It answers the conundrum of choosing between a mono repo or many repos by saying "both", with a meta repo.
...
* [Ultra Runner](https://github.com/folke/ultra-runner) ⭐ 1,247 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-17 is a smart script runner and build tool for Lerna, Pnpm, Rush and Yarn. Scripts run concurrently, using the dependency topology. Builds keep track of file changes and are skipped when possible.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,937 | 🐛 81 | 🌐 Rust | 📅 2026-09-17 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,705 | 🐛 258 | 🌐 C++ | 📅 2026-09-17, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 26,177 | 🐛 21,281 | 🌐 Nix | 📅 2026-09-18
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,301 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-17
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,589 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-17
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,753 | 🐛 20 | 🌐 Rust | 📅 2026-09-17
* [Celo's monorepo (includes blockchain, misc tooling, libraries, ops stuff like terraform modules, docs, etc)](https://github.com/celo-org/celo-monorepo) ⭐ 804 | 🐛 45 | 🌐 Solidity | 📅 2026-09-17
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,484 | 🐛 495 | 🌐 Go | 📅 2026-09-14 generates Bazel BUILD files automatically for Go packages.

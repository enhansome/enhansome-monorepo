...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,318 | 🐛 16 | 🌐 Python | 📅 2026-08-16.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,455 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-16 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,508 | 🐛 2,912 | 🌐 C++ | 📅 2026-08-16 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [Syncpack](https://github.com/JamieMason/syncpack) ⭐ 2,086 | 🐛 17 | 🌐 Rust | 📅 2026-08-09 ensures consistent dependency versions in large JavaScript Monorepos.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,911 | 🐛 92 | 🌐 Rust | 📅 2026-08-16 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,676 | 🐛 252 | 🌐 C++ | 📅 2026-08-16, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 25,826 | 🐛 20,823 | 🌐 Nix | 📅 2026-08-16
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,276 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-14
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,550 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-14
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,746 | 🐛 19 | 🌐 Rust | 📅 2026-08-14
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,481 | 🐛 495 | 🌐 Go | 📅 2026-08-16 generates Bazel BUILD files automatically for Go packages.

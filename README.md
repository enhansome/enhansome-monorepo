...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 317,811 | 🐛 16 | 🌐 Python | 📅 2026-09-01.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,470 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-01 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,611 | 🐛 2,937 | 🌐 C++ | 📅 2026-09-01 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [Ultra Runner](https://github.com/folke/ultra-runner) ⭐ 1,246 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-01 is a smart script runner and build tool for Lerna, Pnpm, Rush and Yarn. Scripts run concurrently, using the dependency topology. Builds keep track of file changes and are skipped when possible.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,921 | 🐛 118 | 🌐 Rust | 📅 2026-09-01 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,700 | 🐛 258 | 🌐 C++ | 📅 2026-09-02, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 25,999 | 🐛 21,044 | 🌐 Nix | 📅 2026-09-02
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,286 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-02
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,571 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-01
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,749 | 🐛 20 | 🌐 Rust | 📅 2026-09-01
* [Celo's monorepo (includes blockchain, misc tooling, libraries, ops stuff like terraform modules, docs, etc)](https://github.com/celo-org/celo-monorepo) ⭐ 804 | 🐛 45 | 🌐 Solidity | 📅 2026-08-31
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,483 | 🐛 496 | 🌐 Go | 📅 2026-09-01 generates Bazel BUILD files automatically for Go packages.
...
* [shopsys/monorepo-tools](https://github.com/shopsys/monorepo-tools) ⭐ 698 | 🐛 1 | 🌐 Shell | 📅 2026-08-31 contains a set of tools for building and splitting a monolithic repository.

...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,356 | 🐛 21 | 🌐 Python | 📅 2026-09-22.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,489 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-22 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,761 | 🐛 2,969 | 🌐 C++ | 📅 2026-09-22 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [Syncpack](https://github.com/JamieMason/syncpack) ⭐ 2,094 | 🐛 19 | 🌐 Rust | 📅 2026-09-06 ensures consistent dependency versions in large JavaScript Monorepos.
* [Ultra Runner](https://github.com/folke/ultra-runner) ⭐ 1,247 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-22 is a smart script runner and build tool for Lerna, Pnpm, Rush and Yarn. Scripts run concurrently, using the dependency topology. Builds keep track of file changes and are skipped when possible.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,942 | 🐛 82 | 🌐 Rust | 📅 2026-09-21 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,712 | 🐛 259 | 🌐 C++ | 📅 2026-09-22, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 26,215 | 🐛 21,384 | 🌐 Nix | 📅 2026-09-23
...
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,604 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-22
* [M3 monorepo - Distributed TSDB, Aggregator and Query Engine, Prometheus Sidecar, Metrics Platform](https://github.com/m3db/m3) ⭐ 4,902 | 🐛 172 | 🌐 Go | 📅 2026-09-22
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,754 | 🐛 19 | 🌐 Rust | 📅 2026-09-22
* [Celo's monorepo (includes blockchain, misc tooling, libraries, ops stuff like terraform modules, docs, etc)](https://github.com/celo-org/celo-monorepo) ⭐ 806 | 🐛 44 | 🌐 Solidity | 📅 2026-09-22
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,484 | 🐛 497 | 🌐 Go | 📅 2026-09-22 generates Bazel BUILD files automatically for Go packages.

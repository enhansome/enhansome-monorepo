...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 313,992 | 🐛 26 | 🌐 Python | 📅 2026-08-05.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,454 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-14 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,504 | 🐛 2,918 | 🌐 C++ | 📅 2026-08-14 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,909 | 🐛 110 | 🌐 Rust | 📅 2026-08-14 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,672 | 🐛 253 | 🌐 C++ | 📅 2026-08-14, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 25,806 | 🐛 21,280 | 🌐 Nix | 📅 2026-08-14
...
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,545 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-14

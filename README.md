...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,580 | 🐛 21 | 🌐 Python | 📅 2026-09-23.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,489 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-23 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,768 | 🐛 2,976 | 🌐 C++ | 📅 2026-09-24 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [Ultra Runner](https://github.com/folke/ultra-runner) ⭐ 1,247 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-23 is a smart script runner and build tool for Lerna, Pnpm, Rush and Yarn. Scripts run concurrently, using the dependency topology. Builds keep track of file changes and are skipped when possible.
...
* [GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,136 | 🐛 319 | 🌐 C# | 📅 2026-09-23 virtualizes the file system beneath your git repo so that git and all tools see what appears to be a normal repo, but GVFS only downloads objects as they are needed. Windows only.
* [josh](https://github.com/esrlabs/josh) ⭐ 1,944 | 🐛 81 | 🌐 Rust | 📅 2026-09-23 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,712 | 🐛 259 | 🌐 C++ | 📅 2026-09-23, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 26,230 | 🐛 21,350 | 🌐 Nix | 📅 2026-09-24
...
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,608 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-23
* [M3 monorepo - Distributed TSDB, Aggregator and Query Engine, Prometheus Sidecar, Metrics Platform](https://github.com/m3db/m3) ⭐ 4,902 | 🐛 173 | 🌐 Go | 📅 2026-09-23
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,755 | 🐛 19 | 🌐 Rust | 📅 2026-09-22
* [Celo's monorepo (includes blockchain, misc tooling, libraries, ops stuff like terraform modules, docs, etc)](https://github.com/celo-org/celo-monorepo) ⭐ 807 | 🐛 38 | 🌐 Solidity | 📅 2026-09-23

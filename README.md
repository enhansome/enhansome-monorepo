...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 319,582 | 🐛 18 | 🌐 Python | 📅 2026-09-01.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,475 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-09 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,662 | 🐛 2,945 | 🌐 C++ | 📅 2026-09-10 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [meta](https://github.com/mateodelnorte/meta) ⭐ 2,221 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-09 is a tool for managing multi-project systems and libraries. It answers the conundrum of choosing between a mono repo or many repos by saying "both", with a meta repo.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,932 | 🐛 83 | 🌐 Rust | 📅 2026-09-09 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,704 | 🐛 258 | 🌐 C++ | 📅 2026-09-09, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 26,068 | 🐛 21,087 | 🌐 Nix | 📅 2026-09-10
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,295 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-10
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,580 | 🐛 154 | 🌐 TypeScript | 📅 2026-09-09
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,750 | 🐛 19 | 🌐 Rust | 📅 2026-09-09
* [Celo's monorepo (includes blockchain, misc tooling, libraries, ops stuff like terraform modules, docs, etc)](https://github.com/celo-org/celo-monorepo) ⭐ 805 | 🐛 45 | 🌐 Solidity | 📅 2026-09-07
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,484 | 🐛 496 | 🌐 Go | 📅 2026-09-09 generates Bazel BUILD files automatically for Go packages.

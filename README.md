...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 315,143 | 🐛 17 | 🌐 Python | 📅 2026-08-16.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,455 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-20 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,541 | 🐛 2,918 | 🌐 C++ | 📅 2026-08-20 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,124 | 🐛 320 | 🌐 C# | 📅 2026-08-20 virtualizes the file system beneath your git repo so that git and all tools see what appears to be a normal repo, but GVFS only downloads objects as they are needed. Windows only.
* [josh](https://github.com/esrlabs/josh) ⭐ 1,914 | 🐛 116 | 🌐 Rust | 📅 2026-08-20 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,685 | 🐛 254 | 🌐 C++ | 📅 2026-08-20, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 25,868 | 🐛 20,718 | 🌐 Nix | 📅 2026-08-20
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,274 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-17
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,558 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-20
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,747 | 🐛 19 | 🌐 Rust | 📅 2026-08-20
* [Celo's monorepo (includes blockchain, misc tooling, libraries, ops stuff like terraform modules, docs, etc)](https://github.com/celo-org/celo-monorepo) ⭐ 801 | 🐛 45 | 🌐 Solidity | 📅 2026-08-20
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,482 | 🐛 500 | 🌐 Go | 📅 2026-08-20 generates Bazel BUILD files automatically for Go packages.

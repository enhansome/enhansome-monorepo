...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 318,297 | 🐛 17 | 🌐 Python | 📅 2026-09-01.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,472 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-04 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,640 | 🐛 2,941 | 🌐 C++ | 📅 2026-09-04 is a package and distribution build tool with remote caching, predominately used by NixOS.
* [Bolt Pkg](https://github.com/boltpkg/bolt) ⭐ 2,429 | 🐛 77 | 🌐 JavaScript | 📅 2024-06-01 is a super-powered JavaScript project management.
...
* [Spago](https://github.com/spacchetti/spago) ⭐ 830 | 🐛 40 | 🌐 PureScript | 📅 2026-08-17 is a PureScript package manager and build tool powered by Dhall and package-sets.
* [Symplify/MonorepoBuilder](https://github.com/Symplify/MonorepoBuilder) ⭐ 527 | 🐛 7 | 🌐 PHP | 📅 2026-07-31 is a PHP monorepo management tool.
* [baur](https://github.com/simplesurance/baur) ⭐ 379 | 🐛 30 | 🌐 Go | 📅 2026-09-01 builds only changed applications in a monorepo branch and manages build artifacts
...
* [drkns](https://github.com/frantzmiccoli/drkns) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2026-08-31 is a simple and language agnostic monorepo build tool.
...
* [meta](https://github.com/mateodelnorte/meta) ⭐ 2,220 | 🐛 34 | 🌐 JavaScript | 📅 2026-09-03 is a tool for managing multi-project systems and libraries. It answers the conundrum of choosing between a mono repo or many repos by saying "both", with a meta repo.
* [Syncpack](https://github.com/JamieMason/syncpack) ⭐ 2,092 | 🐛 19 | 🌐 Rust | 📅 2026-08-09 ensures consistent dependency versions in large JavaScript Monorepos.
* [Ultra Runner](https://github.com/folke/ultra-runner) ⭐ 1,246 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-04 is a smart script runner and build tool for Lerna, Pnpm, Rush and Yarn. Scripts run concurrently, using the dependency topology. Builds keep track of file changes and are skipped when possible.
...
* [GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,134 | 🐛 318 | 🌐 C# | 📅 2026-09-04 virtualizes the file system beneath your git repo so that git and all tools see what appears to be a normal repo, but GVFS only downloads objects as they are needed. Windows only.
* [josh](https://github.com/esrlabs/josh) ⭐ 1,929 | 🐛 121 | 🌐 Rust | 📅 2026-09-04 is a git server proxy enabling on-the-fly virtualization of repositories.
* [splitsh-lite](https://github.com/splitsh/lite) ⭐ 1,611 | 🐛 23 | 🌐 Go | 📅 2025-11-30 is a very fast git subtree alternative to splits subtrees from your project into subprojects.
* [git subtree](https://github.com/apenwarr/git-subtree) ⭐ 1,382 | 🐛 8 | 🌐 Shell | 📅 2017-07-20 merges and splits subtrees from your project into subprojects and back. Part of Git since version 1.7.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,704 | 🐛 258 | 🌐 C++ | 📅 2026-09-04, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [CODEOWNERS generator](https://github.com/gagoar/codeowners-generator) ⭐ 66 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-02 generates a CODEOWNERS file for your monorepo from files in subfolders.
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 26,029 | 🐛 21,213 | 🌐 Nix | 📅 2026-09-05
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,290 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-04
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,571 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-04
* [M3 monorepo - Distributed TSDB, Aggregator and Query Engine, Prometheus Sidecar, Metrics Platform](https://github.com/m3db/m3) ⭐ 4,895 | 🐛 228 | 🌐 Go | 📅 2026-08-17
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,749 | 🐛 19 | 🌐 Rust | 📅 2026-09-04
* [Celo's monorepo (includes blockchain, misc tooling, libraries, ops stuff like terraform modules, docs, etc)](https://github.com/celo-org/celo-monorepo) ⭐ 804 | 🐛 44 | 🌐 Solidity | 📅 2026-09-04
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,484 | 🐛 496 | 🌐 Go | 📅 2026-09-04 generates Bazel BUILD files automatically for Go packages.
* [tomono](https://github.com/unravelin/tomono) ⭐ 921 | 🐛 4 | 🌐 CSS | 📅 2025-09-01 imports an existing set of Git repositories into a monorepo.
* [shopsys/monorepo-tools](https://github.com/shopsys/monorepo-tools) ⭐ 698 | 🐛 1 | 🌐 Shell | 📅 2026-09-02 contains a set of tools for building and splitting a monolithic repository.

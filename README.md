...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 318,532 | 🐛 17 | 🌐 Python | 📅 2026-09-01.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,472 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-05 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,644 | 🐛 2,943 | 🌐 C++ | 📅 2026-09-05 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,135 | 🐛 318 | 🌐 C# | 📅 2026-09-04 virtualizes the file system beneath your git repo so that git and all tools see what appears to be a normal repo, but GVFS only downloads objects as they are needed. Windows only.
* [josh](https://github.com/esrlabs/josh) ⭐ 1,930 | 🐛 90 | 🌐 Rust | 📅 2026-09-05 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,704 | 🐛 258 | 🌐 C++ | 📅 2026-09-05, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 26,033 | 🐛 21,184 | 🌐 Nix | 📅 2026-09-06
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,291 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-04
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,573 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-04
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,749 | 🐛 19 | 🌐 Rust | 📅 2026-09-05

...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 315,341 | 🐛 23 | 🌐 Python | 📅 2026-08-21.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,458 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-21 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,547 | 🐛 2,928 | 🌐 C++ | 📅 2026-08-21 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [Ultra Runner](https://github.com/folke/ultra-runner) ⭐ 1,245 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-21 is a smart script runner and build tool for Lerna, Pnpm, Rush and Yarn. Scripts run concurrently, using the dependency topology. Builds keep track of file changes and are skipped when possible.
...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,913 | 🐛 124 | 🌐 Rust | 📅 2026-08-21 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,691 | 🐛 257 | 🌐 C++ | 📅 2026-08-21, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 25,888 | 🐛 20,777 | 🌐 Nix | 📅 2026-08-21
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,276 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-17
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,558 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-21
* [M3 monorepo - Distributed TSDB, Aggregator and Query Engine, Prometheus Sidecar, Metrics Platform](https://github.com/m3db/m3) ⭐ 4,895 | 🐛 220 | 🌐 Go | 📅 2026-08-17
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,747 | 🐛 19 | 🌐 Rust | 📅 2026-08-21
...
* [Gazelle](https://github.com/bazelbuild/rules_go#generating-build-files) ⭐ 1,482 | 🐛 496 | 🌐 Go | 📅 2026-08-21 generates Bazel BUILD files automatically for Go packages.

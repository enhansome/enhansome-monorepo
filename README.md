...
Inspired by [vinta/awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,497 | 🐛 16 | 🌐 Python | 📅 2026-08-16.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,456 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-17 is a tool for building and managing JavaScript projects with multiple components, and managing the dependency graph of components.
* [Nix](https://github.com/NixOS/nix) ⭐ 17,513 | 🐛 2,913 | 🌐 C++ | 📅 2026-08-17 is a package and distribution build tool with remote caching, predominately used by NixOS.
...
* [GVFS](https://github.com/Microsoft/GVFS) ⭐ 6,124 | 🐛 321 | 🌐 C# | 📅 2026-08-17 virtualizes the file system beneath your git repo so that git and all tools see what appears to be a normal repo, but GVFS only downloads objects as they are needed. Windows only.
* [josh](https://github.com/esrlabs/josh) ⭐ 1,911 | 🐛 96 | 🌐 Rust | 📅 2026-08-17 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,680 | 🐛 252 | 🌐 C++ | 📅 2026-08-17, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
...
* [NixOS's monorepo of packages and modules can be used to incrementally build and deploy Linux machines](https://github.com/NixOS/nixpkgs/) ⭐ 25,833 | 🐛 20,610 | 🌐 Nix | 📅 2026-08-17
* [Berty's monorepo - React-native mobile App + Golang backend + Gomobile bridge + iOS & Android native drivers + Protobuf](https://github.com/berty/berty/) ⭐ 9,278 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-17
* [ProtonMail's monorepo (the proton web clients: mail, calendar...)](https://github.com/ProtonMail/WebClients) ⭐ 5,553 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-17
...
* [Habitat's monorepo](https://github.com/habitat-sh/habitat) ⭐ 2,746 | 🐛 25 | 🌐 Rust | 📅 2026-08-17

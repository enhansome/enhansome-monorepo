...
* [josh](https://github.com/esrlabs/josh) ⭐ 1,916 | 🐛 118 | 🌐 Rust | 📅 2026-08-28 is a git server proxy enabling on-the-fly virtualization of repositories.
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,695 | 🐛 258 | 🌐 C++ | 📅 2026-08-29, replaced by [fsmonitor](https://www.mercurial-scm.org/wiki/FsMonitorExtension) trigger partial, incremental builds when your files change
